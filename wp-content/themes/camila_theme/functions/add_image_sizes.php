...
function dl_image_sizes( $sizes ) {
	...
	$add_sizes = array(
		...
		'services_image' => __('Tamaño personalizado de servicios'),
		'portfolio_image' => __('Tamaño personalizado de portafolio') 
	);
...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'services_image', 400, 400, true );		// Personalización del tamaño del servicio
	add_image_size( 'portfolio_image', 800, 600, true );		// Personalización del tamaño del portafolio
