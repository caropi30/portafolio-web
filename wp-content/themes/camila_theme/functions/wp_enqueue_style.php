...
function dl_enqueue_style() {
	...
	wp_register_style( 'google_fonts', 'https://fonts.googleapis.com/css?family=Montserrat:300,400,700,800&display=swap');
	wp_register_style( 'main_style', get_theme_file_uri('/assets/css/main.css'), $deps, $theme_data->get('Version'), 'screen' );
